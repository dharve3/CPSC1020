// This program demonsrates the polymorphic behavior of C++.
#include "inheritance_vm.h"
#include <vector>
#include <iostream>
using namespace std;
...
int main()
{
    ...
    vector<shared_ptr<Person>> people
    {
        ...
        make_shared<Student>("Thomas Cruise (student)", Discipline::COMPUTER_SCIENCE, nullptr),
