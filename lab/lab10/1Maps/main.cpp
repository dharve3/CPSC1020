...
int main() {
    std::string sentence = "Remember I have been prophesying for the
    past sixty five years that in the natural course of things I a square a
    mere Square shall evolve into a Pentagon or five sided figure and from
    there into a Hexagon or six sided figure and thence into a Cube or in
    other words into the so called regular solids with a myriad of various
    other forms of which the chief are the tetrahedron the octahedron and
    the dodecahedron";
